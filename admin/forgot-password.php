...
<html>
<head>
<title>Zoya Beauty | Esqueceu a Senha </title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page login-page ">
				<h3 class="title1">Esqueceu a Senha</h3>
				<div class="widget-shadow">
					<div class="login-top">
						<h4>Bem-Vindo a Zoya Beauty AdminPianel ! </h4>
					</div>
    ...
    echo $msg;
							...
							<div class="forgot-grid">
								...
								<div class="forgot">
									<a href="index.php">Já tens uma conta</a>
								</div>
