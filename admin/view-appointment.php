...
if(isset($_POST['submit']))
  {
   ...
   $query=mysqli_query($con, "update  tblappointment set Remark='$remark',Status='$status' where ID='$cid'");
    if ($query) {
    $msg="Todas as observações foram atualizadas.";
  }
  else
    {
...
<html>
<head>
<title>Zoya Beauty || Ver Marcação</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Ver Marcação</h3>
...
<tr>
  ...
  <tr>
   ...
   <select name="status" class="form-control wd-450" required="true" >
     <option value="1" selected="true">Selecionado</option>
