...
<html>
<head>
<title>Zoya Beauty | Atualizar Serviços</title>
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Atualizar Serviços</h3>
...
?> 
							 ...
							 <div class="form-group"> <label for="exampleInputPassword1">Contacto</label> <input type="text" id="mobilenum" name="mobilenum" class="form-control"  value="<?php  echo $row['MobileNumber'];?>" required="true"> </div>
							 <div class="form-group"> <label for="exampleInputPassword1">Gênero</label> <?php if($row['Gender']=="Male")
 ...
 <input type="radio" id="gender" name="gender" value="Masculino" >Masculino
  ...
  <!--<input type="radio" name="gender" value="Transgender" checked="true">Transgender-->
                   ...
                   <div class="form-group"> <label for="exampleInputPassword1">Creation Date</label> <input type="text" id="" name="" class="form-control"  value="<?php  echo $row['CreationDate'];?>" readonly='true'> </div>
							 ...
							 <?php } ?>
							  <button type="submit" name="submit" class="btn btn-default">Atualizar</button> </form> 
						</div>
