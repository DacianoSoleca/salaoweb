...
<html>
<head>
<title>Zoya Beauty | Encontre-nos</title>
	...
	<div class="main-content">
	 ...
	 <?php include_once('includes/header.php');?>
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="forms">
					<h3 class="title1">Atualizar nosso Endereço</h3>
