...
$y2=date("Y",$month2);
    ?>
<h4 class="header-title m-t-0 m-b-30">Relatório de Vendas Mensais</h4>
<h4 align="center" style="color:blue">Relatório de <?php echo $m1."-".$y1;?> à <?php echo $m2."-".$y2;?></h4>
<hr />
...
$y2=date("Y",$year2);
 ?>
 <h4 class="header-title m-t-0 m-b-30">Relatório de Vendas Anuais</h4>
    <h4 align="center" style="color:blue">Relatório de <?php echo $y1;?> à <?php echo $y2;?></h4>
    <hr />
    <table class="table table-bordered">  <thead>
<tr>
<th>S.NO</th>
