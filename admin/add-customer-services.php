...
<html>
<head>
<title>Zoya Beauty || Atribuir Serviços</title>
...
<body class="cbp-spmenu-push">
	<div class="main-content">
		...
		<div id="page-wrapper">
			<div class="main-page">
				<div class="tables">
					<h3 class="title1">Atribuir Serviços</h3>
					...
					<div class="table-responsive bs-example widget-shadow">
						<h4>Serviços Zoya:</h4>
<form method="post">
						<table class="table table-bordered"> <thead> <tr> <th>#</th> <th>Nome</th> <th>Preço</th> <th>Acção</th> </tr> </thead> <tbody>
<?php
