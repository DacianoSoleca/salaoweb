...
<html lang="en">
  <head>
    <title>Zoya Beauty-Marcação feita</title>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5">
            <h2 class="mb-0 bread">Marcação feita</h2>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Página Inicial <i class="ion-ios-arrow-forward"></i></a></span> Thank You<span> <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="ftco-section ftco-no-pb">
    	<div class="container">
          ...
          <div class="col-md-6 text-center heading-section ftco-animate">
          	<h4 class="w3ls_head">Muito obrigado pela sua visita, sua reserva foi feita com sucesso. Reserva número <?php echo $_SESSION['aptno'];?> </h4>
        </div>
    	</div>
