...
<html lang="en">
  <head>
    <title>Zoya Beauty-Contactos</title>
      ...
      <div class="container">
        <div class="row no-gutters slider-text js-fullheight align-items-end justify-content-center">
          <div class="col-md-9 ftco-animate pb-5">
            <h2 class="mb-0 bread">Encontre-nos</h2>
            <p class="breadcrumbs"><span class="mr-2"><a href="index.php">Página Inicial <i class="ion-ios-arrow-forward"></i></a></span> <span>Contactos <i class="ion-ios-arrow-forward"></i></span></p>
          </div>
        </div>
      </div>
    </section>
...
?>
          ...
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
	            ...
	            <p><a href="tel://1234567920">+244 <?php  echo $row['MobileNumber'];?></a></p>
	          </div>
          </div>
          <div class="col-md-3 d-flex">
          	<div class="align-self-stretch box p-4 py-md-5 text-center">
